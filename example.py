...
from dash_extensions.enrich import TriggerTransform
...
app.layout = html.Div(
    [
        ...
        html.Div(id="container", children=[create_child('default')]),
    ]
)
